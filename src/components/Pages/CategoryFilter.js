...
const guitarra = [
  {
    ...
    url: "https://res.cloudinary.com/pruebasmern/image/upload/v1648474799/Music%20Shop/guitar-electrica_ezzhjk.png",
    filter: "ELÉCTRICA",
  },
  {
...
const teclado = [
  {
    ...
    url: "https://res.cloudinary.com/pruebasmern/image/upload/v1648477318/Music%20Shop/pidigital_l4ufy5.jpg",
    filter: "TECLADO DIGITAL",
  },
  {
    name: "Piano Digital",
    url: "https://res.cloudinary.com/pruebasmern/image/upload/v1648477318/Music%20Shop/pidigital_l4ufy5.jpg",
    filter: "PIANO DIGITAL",
  },
  {
    name: "Piano Acústico",
    url: "https://res.cloudinary.com/pruebasmern/image/upload/v1648477318/Music%20Shop/pianoacus_af3mb5.webp",
    filter: "PIANO ACÚSTICO",
  },
];
...
const CategoryFilter = () => {
  ...
  useEffect(() => {
    const peticionGet = async () => {
      ...
      await axios
        .get(`${process.env.REACT_APP_BACKEND}api/category/${id}`)
        .then((response) => {
          setTablaProducts({
